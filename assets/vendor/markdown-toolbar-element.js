/* @github/markdown-toolbar-element v2.2.3 — MIT © GitHub
 * https://github.com/github/markdown-toolbar-element
 * Vendored from https://unpkg.com/@github/markdown-toolbar-element@2.2.3/dist/index.js
 * Local patches (documented, do not re-vendor without reapplying):
 *   1. Trailing `export default MarkdownToolbarElement;` removed so the ESM
 *      dist loads as a classic script (no build step on this site).
 *   2. Italic style `_x_` → `*x*` in both style objects, matching this
 *      site's markdown renderer, which only parses asterisk italics.
 */
